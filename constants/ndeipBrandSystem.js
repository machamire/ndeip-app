...
// Get dimensions safely - use a function to avoid initialization issues
...
// Helper function to get current screen width safely
...
// Remove direct screenWidth/screenHeight constants to avoid initialization issues
// Use getCurrentScreenWidth() and getScreenDimensions() functions instead
...
// Use getter functions to avoid initialization issues
export const MeshBreakpoints = {
  ...
  // Device detection - use getters to evaluate at access time
  get isMobile() {
    return getCurrentScreenWidth() < 768;
  },
  get isTablet() {
    const width = getCurrentScreenWidth();
  ...
  get isDesktop() {
    return getCurrentScreenWidth() >= 1024;
  },
